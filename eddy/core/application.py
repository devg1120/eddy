...
class Eddy(QtWidgets.QApplication):
    ...
    def configure(self, options):
        ...
        if not settings.contains('project/recent'):
            # From PySide6 documentation: if the value of the setting is a container (corresponding
            ...
            # PySide6 needs to know the type of the contents added to the collection: we avoid
